...
export const workTimeline: readonly TimelineEntry[] = [
    {
        ...
        period: 'Jan–May 2026',
        description: 'Worked across four projects, ranging from application work, system restoration, technical audit, cloud-host and CI/CD research, WordPress/PHP, and live video production.',
    },
    {
        ...
        description: 'Handled the preparation, management and technical execution of the broadcast, as well as the in-game camerawork.',
    },
    {
